...
# Store the plot
  thermo_plots[[covar]] <- g
}
```

# Save figure 5 and figure 6
```{r}
# Define width and height of plots
w <- 15
h <- 5
...
# Figure 5 - Free T4 ----
    ...
    figure_5 <- top_5_plots[["FreeT4"]] + thermo_plots[["FreeT4"]] + plot_layout(ncol = 1) + plot_annotation(tag_levels = "A")


    ggsave(
    filename = file.path("../output/5_6 - Figures and Analysis/figures",  paste0(date_prefix, "_Figure_5_FreeT4.tiff")),
    plot = figure_5, device = "tiff", width = w, height = h*2, units = "in", dpi = 600, create.dir = T
  )
  
  pdf(file.path("../output/5_6 - Figures and Analysis/figures",  paste0(date_prefix, "_Figure_5_FreeT4.pdf")), width = w, height = h*2)
  # Print plot to PDF
  print(figure_5)
...
# Figure 6 - Free T3 ----
    ...
    figure_6 <- top_5_plots[["FreeT3"]] + thermo_plots[["FreeT3"]] + plot_layout(ncol = 1) + plot_annotation(tag_levels = "A")


    ggsave(
    filename = file.path("../output/5_6 - Figures and Analysis/figures",  paste0(date_prefix, "_Figure_6_FreeT3.tiff")),
    plot = figure_6, device = "tiff", width = w, height = h*2, units = "in", dpi = 600, create.dir = T
  )
  
  pdf(file.path("../output/5_6 - Figures and Analysis/figures",  paste0(date_prefix, "_Figure_6_FreeT3.pdf")), width = w, height = h*2)
  # Print plot to PDF
  print(figure_6)
