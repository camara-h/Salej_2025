...
# Read each sheet into a list of data frames and process them
sheets <- lapply(sheet_names, function(sheet) {
  df <- read_excel(path, sheet = sheet)
  df$Cluster <- sheet
  df$Description <- format_text(df$Description)  # Format pathway description
  return(df)
})
...
# Add the combined data frame to the path_list
