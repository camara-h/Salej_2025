...
```{r}
path_list <- list(
  HypoHyper = read.csv("../data/HypoHyper_weight/gene_stats.csv", row.names = 1),
  UCP1 = read.csv("../data/UCP1_weight/gene_stats.csv", row.names = 1),
  NoAdjustment = read.csv("../data/No_weight/gene_stats.csv", row.names = 1),
